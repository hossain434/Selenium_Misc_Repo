...
public class writeexcel {
    ...
    Sheet sheet = myexcel.getSheet(sheetName);
    //Get the current count of rows in xcel file
    ...
    public static void main(String...strings) throws IOException{
        ...
        objExcelFile.writeExcel(System.getProperty("user.dir")+"\\","TestCase.xlsx" , "KeywordFramework",valueToWrite);
    }
